...
public class LoadSaveXML {
     ...
     * </ul>
     * marshal (= Save) to <tt>.xml</tt> from {@link com.team.shared.engine.engine.Engine}'s {@code stocks}.
     *
    ...
    public static void marshal(String stringPathOfXML) throws IOException {
        ...
        if ((stringPathOfXML.length() >= 4) &&
            ...
            try {
                ...
                // Marshal in file
                jaxbMarshaller.marshal(com.team.shared.engine.engine.Engine.createDescriptor(),
     ...
     *      <li>{@link NullPointerException}</li>
     *  </ul>
     * unmarshal (= Load) from '.xml' to {@link com.team.shared.engine.engine.Engine}'s {@code stocks} and
     * {@link com.team.shared.engine.engine.Engine}'s {@code users}, while <i>checking</i> their validity
     * first.
     *
    ...
    public static void unmarshal(String pathOfXML) throws IOException {
        ...
        if ((pathOfXML.length() >= 4) &&
            ...
            try {
                ...
                com.team.shared.engine.engine.Engine.setStocks(stocks);
    ...
    private static void checkAndSetStocksInEngine(Stocks stocks)
        ...
        // stocks found as valid, so we are allowed to set the Stocks:
        com.team.shared.engine.engine.Engine.setStocks(stocks); // set stocks of Engine.
    }
     ...
     *               with the given {@link Users} {@link Holdings}
     *               {@link Stock} {@code Symbol}s.
    ...
    private static void checkAndSetUsersInEngine(Users users, Stocks stocks)
        ...
        com.team.shared.engine.engine.Engine.setUsers(users); // set users of Engine.
    }
    ...
    private static void checkValidStocks(Stocks stocks) throws IOException {
        try {
            ...
            // check the validation of the stocks in the File given:
            com.team.shared.engine.engine.Engine.checkValidStocks(stocks);
        } catch (IOException e) {
